...
| **LightGBM (Statcast)** | 53 特徴量 + Optuna（投球・打球・バットトラッキング・パークファクター） |
...
- [ ] **LightGBM Optuna 50 trial 結果待ち**（カラムガード修正後再実行中）
...
- [ ] **初回学習結果待ち**（SVI 20,000 steps、2015–2023 学習 / 2024 ホールドアウト）
- [ ] チーム力ランキング・球場効果の検証
