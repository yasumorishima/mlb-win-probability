...
| **LightGBM (Statcast + FanGraphs)** | **157 特徴量**（Statcast 76 + FG 投手 46 + FG 打者 35）+ Optuna 50 trial |
...
- **Bayesian stacking**: LightGBM が投球・打球・バットトラッキング・FanGraphs 打者/投手指標等 **157 特徴量**を処理、ベイズ層がチーム力・球場・時代効果 + 不確実性を上乗せ
...
**157 特徴量**（Statcast 76: 投球速度・変化量・打球・バットトラッキング・ゾーン・軌道等 + FanGraphs 投手 46: Stuff+/SIERA/ERA-/ゾーン別制球等 + FanGraphs 打者 35: wRC+/選球眼/打球傾向/走塁等）、Optuna 50 trial。MLB Stats API live feed からリアルタイム取得可能。
...
| **LightGBM (Statcast + FG)** | 勾配ブースティング（**157 特徴量**: Statcast 76 + FG 投手 46 + FG 打者 35、Optuna 50 trial） | **リアルタイム対応、FG シーズン指標で打者・投手の質を反映** |
...
- [x] **157 特徴量エンジニアリング**（Statcast 76: 投球・打球・バットトラッキング・ゾーン・軌道 + FanGraphs 投手 46: Stuff+/SIERA/ERA-/ゾーン制球 + FanGraphs 打者 35: wRC+/選球眼/打球傾向/走塁/WAR）
...
- [x] **FanGraphs 全指標統合（157 特徴量）** — 投手 46 指標（Stuff+/SIERA/ERA-/ゾーン制球等）+ 打者 35 指標（wRC+/選球眼/打球傾向/走塁/WAR 等）を BQ マスタ経由で投球単位データに join
- [ ] **157 特徴量 Statcast+FG + Bayesian + Ensemble 学習・評価**
